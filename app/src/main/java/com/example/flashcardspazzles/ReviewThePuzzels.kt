...
class ReviewThePuzzels : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {

        val questions = arrayOf(
            "question 1-Mandela was the first president in South Africa?",
        ...
        setContent {
            ...
            )
            {
                ...
                Button(
                    onClick = {
                        //this button takes you back to the MainActivity
                        val exit = Intent(this@ReviewThePuzzels, MainActivity::class.java)
                        startActivity(exit)
